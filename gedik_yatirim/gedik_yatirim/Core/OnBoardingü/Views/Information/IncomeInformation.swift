    ...
    var body: some View {
        ZStack{
            VStack{
                ...
                ButtonSheet(isSheetPresendet: $viewModel.isSheetPresendetgelir, textAuto: viewModel.gelirText, title:"Aylık Geliriniz")                    .sheet(isPresented : $viewModel.isSheetPresendetgelir){
