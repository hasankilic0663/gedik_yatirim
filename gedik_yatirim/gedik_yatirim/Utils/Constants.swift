...
struct Constants {
    ...
    static let FillColorFillColor100: Color = Color(red: 0.9, green: 0.93, blue: 1)
    static let RedRed600: Color = Color(red: 0.69, green: 0, blue: 0)
    static let GreyGrey100: Color = Color(red: 0.93, green: 0.94, blue: 0.96)
    ...
    static let GreyGrey500: Color = Color(red: 0.78, green: 0.82, blue: 0.88)
